...
cameraURL01="http://10.123.45.11:5002/webapi/entry.cgi?camStm=2&version=%228%22&cameraId=11&api=%22SYNO.SurveillanceStation.Camera%22&preview=true&method=%22GetSnapshot%22&_sid=" + SID
cameraURL02="http://10.123.45.11:5002/webapi/entry.cgi?camStm=2&version=%228%22&cameraId=15&api=%22SYNO.SurveillanceStation.Camera%22&preview=true&method=%22GetSnapshot%22&_sid=" + SID
cameraURL03="http://10.123.45.11:5002/webapi/entry.cgi?camStm=2&version=%228%22&cameraId=22&api=%22SYNO.SurveillanceStation.Camera%22&preview=true&method=%22GetSnapshot%22&_sid=" + SID
cameraURL04="http://10.123.45.11:5002/webapi/entry.cgi?camStm=2&version=%228%22&cameraId=23&api=%22SYNO.SurveillanceStation.Camera%22&preview=true&method=%22GetSnapshot%22&_sid=" + SID
...
cameraURL07="http://10.123.45.11:5002/webapi/entry.cgi?camStm=2&version=%228%22&cameraId=11&api=%22SYNO.SurveillanceStation.Camera%22&preview=true&method=%22GetSnapshot%22&_sid=" + SID
cameraURL08="http://10.123.45.11:5002/webapi/entry.cgi?camStm=2&version=%228%22&cameraId=11&api=%22SYNO.SurveillanceStation.Camera%22&preview=true&method=%22GetSnapshot%22&_sid=" + SID
cameraURL09="http://10.123.45.11:5002/webapi/entry.cgi?camStm=2&version=%228%22&cameraId=11&api=%22SYNO.SurveillanceStation.Camera%22&preview=true&method=%22GetSnapshot%22&_sid=" + SID
...
def refreshCam01():
	try:
		tmp_photo = ImageTk.PhotoImage(Image.open(BytesIO(requests.get(cameraURL01, timeout=4).content)).resize((int(RWidth/3),int(RHeight/3)), Image.ANTIALIAS))
